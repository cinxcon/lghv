  ...
  return (
    <>
      ...
      <div className='ApprovalStandbyDetail'>
        ...
        <Popup1 open={confirm} close={() => { setConfirm(false) }} header="확인">
          <div>결재 하시겠습니까?</div>
        </Popup1>
        <Popup1 open={agree} close={() => { setAgree(false) }} header="확인">
          <div>결재를 합의 하시겠습니까?</div>
        </Popup1>
        <Popup1 open={onTime} close={() => { setOnTime(false) }} header="OnTime반려">
          <div>반려 하시겠습니까?</div>
        </Popup1>
        <Popup1 open={onTimeCancel} close={() => { setOnTimeCancel(false) }} header="반려취소">
          <div>반려를 취소 하시겠습니까?</div>
        </Popup1>
        <Popup2 open={notimethod} close={() => { setNotimethod(false) }} header="통보방법">
          <PopupNotiMethod />
        </Popup2>
        <Popup2 open={history} close={() => { setHistory(false) }} header="처리내역">
          <PopupProcessHistory />
        </Popup2>
        <h3>결재</h3>
