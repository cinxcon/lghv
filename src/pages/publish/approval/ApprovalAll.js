    ...
    <>
      ...
      <div className="content-title">
        ...
        <div className="breadcrumb">
          ...
          <Link to='' className='color-default'>공람문서함</Link>
        </div>
      </div>
      {/* 검색 영역 */}
      {/* <ApprovalSearch /> */}
        ...
        <table className="table result">
          ...
          <tbody>
            <tr>
              ...
              <td>홍길동</td>
              <td>영서 방송</td>
              <td><Link className='link' to="/ApprovalAllDetail">작업 제목1</Link></td>
            ...
            <tr>
              ...
              <td>홍길동</td>
              <td>영서 방송</td>
              <td><Link className='link' to="/ApprovalAllDetail">작업 제목2</Link></td>
              <td>2023-02-15 02:00</td>
              <td>2023-02-15 03:00</td>
              <td>2023-02-15 03:00</td>
              <td>결재완료</td>
            </tr>
          </tbody>
