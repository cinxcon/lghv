    ...
    <>
      ...
      <div className="content-title">
        ...
        <div className="breadcrumb">
          ...
          <Link to='' className='color-default'>결재완료함</Link>
        </div>
      </div>
      {/* 검색 영역 */}
      {/* <ApprovalSearch /> */}
        ...
        <table className="table search">
          ...
          <tbody>
            <tr>
              <th scope="row">제목</th>
              <td>
                <span className='input'>제목 입니다</span>
              </td>
              <th scope="row">등록번호</th>
              <td>
                <span className='input'>124567890</span>
              </td>
            </tr>
            <tr>
              <th scope="row">등록자</th>
              <td>
                <span className='input'>홍길동</span>
              </td>
            ...
            <tr>
              ...
              <td colSpan={3}>
                <fieldset>
                  <legend>구분</legend>
                  <input type="checkbox" name="division" id="div_1" value="" checked="checked" />
        ...
        <table className="table result">
          ...
          <tbody>
            <tr>
              ...
              <td>홍길동</td>
              <td>영서 방송</td>
              <td><Link className='link' to="/ApprovalCompleteDetail">작업 제목</Link></td>
